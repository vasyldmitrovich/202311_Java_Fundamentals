...
public class EmployeeManagementSystem {
    ...
    public EmployeeManagementSystem() {
        addEmployee(new Employee(1, "Alice", Position.DEV, 10_000, LocalDate.parse("1999-01-30")));
        addEmployee(new Employee(2, "Bob", Position.QA, 10_000, LocalDate.parse("2000-03-03")));
    }
    ...
    private void editEmployee() {
        ...
        System.out.println("Enter new position or an empty line to keep current (one of " +
    ...
    private Employee prompNewEmployee() {
        var scan = new Scanner(System.in);
